...
```bash
$ git clone git@github.com:username/dcordova.git
```

This will clone your fork to your current path in a directory named `dcordova`.
...
```bash
$ cd dcordova
$ git remote add upstream git@github.com:ibm-dojo/dcordova.git
$ git fetch upstream
```
