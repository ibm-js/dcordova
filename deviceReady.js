define(function () {
	...
	function deviceReady(callback) {
		...
		//		executes immediately irrespective of the deviceready event. The callback receives true as its first
		// 		and single argument in Cordova context and false otherwise.
